...
async function main() {
  ...
  const eventsData = [
    ...
    { date: '07-6-2026', dayTe: 'ఆదివారం సా॥', dayEn: 'Sunday Evening', eventTe: 'అగ్నిగుండ ప్రవేశం', eventEn: 'Agni Gunda Pravesham (Sacred Fire Walk)', sponsorTe: 'శ్రీ బాలుపల్లి గ్రామస్తులచే జరుపబడును', sponsorEn: 'Will be conducted by Balupalli villagers', icon: '🔥', highlight: true, fee: '₹100' },
